...
import { User, Phone, MapPin, Calendar, Mail, Building2, Camera, Lock, CheckCircle2, Eye, EyeOff } from "lucide-react";
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (formData.newPassword) {
          toast.success("Password changed. Please log in again if required.");
  ...
  return (
    <PageTransition>
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-sm">{t("accountSettings.subtitle", "Manage your citizen profile and security settings")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 bg-card border rounded-lg shadow-sm overflow-hidden flex flex-col h-fit sticky top-6">
          ...
          <div className="pt-16 pb-6 px-6 text-center flex-1">
            ...
            <p className="text-sm font-medium text-primary mt-1">{t("accountSettings.citizenRole", "Citizen")}</p>
            ...
            <div className="mt-6 space-y-3 text-left bg-muted/30 p-4 rounded-lg border text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="capitalize">{profile.authProvider}</span> {t("accountSettings.loginProvider", "Login")}
              </div>
              <div className="flex items-center gap-3">
